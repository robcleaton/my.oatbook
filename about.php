...
$pageTitle = "About";
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <h1>About us</h1>
        <p>Founded in 2012 in the UK, OATBook was created by Rob Cleaton from his own experiences of receiving a mechanical valve and now running a life long course of living with warfarin.</p>
        <p>OATBook was created to help patients feel empowered and take control of their health.</p>
      </div>
    </div>
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="row">
        <div class="col-md-8">
          ...
          <p>Here some answers to common questions, if you're still having an issue after these then please do <a href="#">get in touch directly</a></p>
        </div>
      </div>
      ...
      <!-- How do I add a new INR reading? -->
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
      ...
      <!-- How do I add alternate dosages? -->
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseThree">
      ...
      <!-- Support us when you visit your clinic? -->
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven" aria-expanded="false" aria-controls="collapseThree">
              Want to support us when you visit the clinic?
            </a>
          </h4>
        </div>
